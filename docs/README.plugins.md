...
| ---- | ----------- | ----- | ---- |
| [autosar-development-toolkit](../plugins/autosar-development-toolkit/README.md) | Complete AUTOSAR Classic Platform development toolkit: architecture design, SWC development, BSW configuration, MISRA-C compliance, RTE engineering, linker/memory management, and embedded testing. | 18 items | autosar, embedded, automotive, misra, arxml, bsw, rte, safety, iso26262 |
