...
This is an internal golden repo for embedded and automotive development, based on the AURA Marketplace framework. It provides a contribution model for company users to add specialized GitHub Copilot resources for embedded systems, AUTOSAR, safety-critical development, and related domains. The project includes:
