...
const GITHUB_RAW_BASE = "https://raw.githubusercontent.com/github/aura-marketplace/main";
const WEBSITE_BASE = "https://aura-marketplace.github.com";
...
export const GET: APIRoute = async () => {
  ...
  content += "## Repository\n\n";
  content += "- **GitHub**: https://github.com/github/aura-marketplace\n";
  content += "- **License**: MIT\n";
  content += "- **Website**: https://aura-marketplace.github.com\n";
